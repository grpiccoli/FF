...
namespace FPFI.Controllers
{
    public class Input3Controller : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Entry3Id,DBH_sd,DBH_max,Random_SI,Random_BA,Id,Id_,Macrostand,Pyear,Age,N,BA,Dg,D100,Hd,Vt,Years,ThinningAges,NAfterThins,ThinTypes,ThinCoefs,Hp,Hm")] Input3 input3)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Entry3Id,DBH_sd,DBH_max,Random_SI,Random_BA,Id,Id_,Macrostand,Pyear,Age,N,BA,Dg,D100,Hd,Vt,Years,ThinningAges,NAfterThins,ThinTypes,ThinCoefs,Hp,Hm")] Input3 input3)
        {
            if (id != input3.Id)
            {
                return NotFound();
